	...
	<cfif lcl.list.recordcount>			
		...
		<cfsavecontent variable="lcl.s.html">
			...
			<cfoutput query="lcl.list">
				<li><a <cfif lcl.id EQ lcl.list.id[lcl.list.currentrow]>class="selected" <cfset lcl.acc.setselected(lcl.count)></cfif> href="../editProduct/?id=#id#">#name#</a></li>
			</cfoutput>
			</ul>
			</div>
		</cfsavecontent>
		<cfset lcl.acc.add('Products',lcl.s.html)>
	<cfelse>
		
		<cfset lcl.acc.add('No Products Loaded',"")>
	</cfif>
</cfsilent>
